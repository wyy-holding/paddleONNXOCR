...
from paddleONNXOCR.predict.ocr_dataclass import OCRResult, PdfResult, TableHtml
...
class OCRResponse(BaseResponse):
    data: List[Union[OCRResult, PdfResult,List[TableHtml]]] = Field(default=[], description="ocr列表识别结果")
